...
from finance_risk_router.executor import build_executor
from finance_risk_router.selectors import build_hybrid_selector, build_retrieval_selector, build_rule_selector
...
def main() -> None:
    retrieval_result = _run("finance_risk_router_retrieval", build_retrieval_selector(TRAIN_CASES_PATH), 0.60)
    rule_result = _run("finance_risk_router_rule", build_rule_selector(), 0.60)
    hybrid_result = _run("finance_risk_router_hybrid", build_hybrid_selector(TRAIN_CASES_PATH), 0.60)
