...
from customer_support_router.executor import build_executor
from customer_support_router.selectors import build_retrieval_selector, build_rule_selector, build_hybrid_selector
...
def main() -> None:
    retrieval_result = _run('customer_support_router_retrieval', build_retrieval_selector(TRAIN_CASES_PATH), threshold=0.60)
    rule_result = _run('customer_support_router_rule', build_rule_selector(), threshold=0.60)
    hybrid_result = _run('customer_support_router_hybrid', build_hybrid_selector(TRAIN_CASES_PATH), threshold=0.60)
