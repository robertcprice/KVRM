...
from legal_compliance_router import build_executor
from legal_compliance_router import build_hybrid_selector, build_retrieval_selector, build_rule_selector
...
def main() -> None:
    retrieval_result = _run("legal_compliance_router_retrieval", build_retrieval_selector(TRAIN_CASES_PATH), 0.60)
    rule_result = _run("legal_compliance_router_rule", build_rule_selector(), 0.60)
    hybrid_result = _run("legal_compliance_router_hybrid", build_hybrid_selector(TRAIN_CASES_PATH), 0.60)
