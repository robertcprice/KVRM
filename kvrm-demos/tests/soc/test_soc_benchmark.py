...
from soc_playbook_router import build_retrieval_selector, build_hybrid_selector
...
def test_soc_benchmark_runs_and_writes_artifacts(tmp_path):
    ...
    result = BenchmarkRunner(runtime, REGISTRY_PATH, CASES_PATH, tmp_path).run(run_name='soc_test')
