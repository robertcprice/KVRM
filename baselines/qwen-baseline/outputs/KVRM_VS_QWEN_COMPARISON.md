# KVRM vs Qwen Baseline: Comparison Report

Generated: 2026-04-07T03:12:48.792748+00:00

## Executive Summary

This report compares the KVRM bounded-action architecture against
a sklearn proxy for a fine-tuned Qwen 0.5-0.8B model across three
domains: SRE, SOC, and Drone mission routing.

The sklearn proxy is intentionally strong — random forests and
gradient boosting classifiers with enough capacity to memorize
the small training sets. This represents an upper-bound estimate
of what a fine-tuned small LM could achieve on these datasets.

---

## SRE Domain

| Metric | KVRM Hybrid | Qwen Direct | Qwen JSON | Qwen Constrained |
|--------|-------------|-------------|-----------|------------------|
...
## Analysis: Where Qwen Baseline Wins
...
The comparison confirms the moat thesis: KVRM's value is not in
classification accuracy (where a fine-tuned LM can compete) but in
